								...
								?>
										<tr class="user_row_<?php echo $user['user_id']; ?>">
											...
											<td>
												...
												<a href="<?php echo base_url().'index.php/Admin/purchaseproject?uid='.$user['user_id']; ?>" class="btn waves-effect waves-light btn-outline-primary primary_btn_hover" data-id="<?php echo $user['user_id']; ?>">Purchase Course</a> 
											</td>
										</tr>
								<?php
									}
