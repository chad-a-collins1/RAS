			...
			<div class="container-fluid">
				...
				<div class="row page-titles">
					<div class="col-md-12 align-self-center">
						<h4 class="theme-cl">Dashboard1</h4>
							...
							<div class="padd-15 blox_instagram_quatro_container">
								<div class="blox_image_box">
									...
									<div class="blox_profile_pic">
										<img src="assets/dist/img/user-2.jpg" alt="">
									</div>
									
									<ul class="blox_image_list">
										<li>
											<a href="#">
												<img src="assets/dist/img/gallery/thumb-md-1.jpg" alt="">
											</a>
										</li>
										<li>
											<a href="#">
												<img src="assets/dist/img/gallery/thumb-md-2.jpg" alt="">
											</a>
										</li>
										<li>
											<a href="#">
												<img src="assets/dist/img/gallery/thumb-md-3.jpg" alt="">
											</a>
										</li>
										<li>
											<a href="#">
												<img src="assets/dist/img/gallery/thumb-md-4.jpg" alt="">
											</a>
										</li>
									</ul>
								</div>
							...
							<div class="card-body padd-0">
								<div class="table-responsive">
									<table class="table table-lg table-hover">
										...
										<tbody>
											<tr>
												<td><a href="#"><img src="assets/dist/img/pro-1.png" class="avatar" alt="Avatar">Livka Lice</a></td>
												<td>#258475</td>
											...
											<tr>
												<td><a href="#"><img src="assets/dist/img/pro-2.png" class="avatar" alt="Avatar">Likez Perfume</a></td>
												<td>#249578</td>
											...
											<tr>
												<td><a href="#"><img src="assets/dist/img/pro-3.png" class="avatar" alt="Avatar">Tiver Perfume</a></td>
												<td>#248712</td>
											...
											<tr>
												<td><a href="#"><img src="assets/dist/img/pro-4.png" class="avatar" alt="Avatar">White Blix Bag</a></td>
												<td>#287246</td>
												<td><div class="label cl-success bg-success-light">Paid</div></td>
												<td>$ 482.70</td>
												<td>06/09/2016</td>
							...
							<div class="ground-list todo-browser ground-list-hove">
								<div class="ground ground-single-list padd-0">
									<a class="todo todo-default" href="#">
									  <span class="ct-title">
										<img src="assets/dist/img/bwser-1.png" class="img-responsive" alt="">Google Chrome
									  </span>
								...
								<div class="ground ground-single-list padd-0">
									<a class="todo todo-default" href="#">
									  <span class="ct-title">
										<img src="assets/dist/img/bwser-2.png" class="img-responsive" alt="">Inter Explorer
									  </span>
								...
								<div class="ground ground-single-list padd-0">
									<a class="todo todo-default" href="#">
									  <span class="ct-title">
										<img src="assets/dist/img/bwser-3.png" class="img-responsive" alt="">FireFox
									  </span>
								...
								<div class="ground ground-single-list padd-0">
									<a class="todo todo-default" href="#">
									  <span class="ct-title">
										<img src="assets/dist/img/bwser-4.png" class="img-responsive" alt="">Safari
									  </span>
								...
								<div class="ground ground-single-list padd-0">
									<a class="todo todo-default" href="#">
									  <span class="ct-title">
										<img src="assets/dist/img/bwser-6.png" class="img-responsive" alt="">Opera
									  </span>
									  <span class="font-medium">40%</span>
									</a>
								</div>
					...
					<div class="col-md-4 col-sm-12">
						<div class="blox_instagram_preview mb-4">
							...
							<div class="padd-10 blox_instagram_preview_container">
								<div class="blox_image_box">
									<ul class="blox_image_list">
										<li><img src="assets/dist/img/gallery/thumb-sm-1.jpg" alt=""></li>
										<li><img src="assets/dist/img/gallery/thumb-sm-2.jpg" alt=""></li>
										<li><img src="assets/dist/img/gallery/thumb-sm-3.jpg" alt=""></li>
										<li><img src="assets/dist/img/gallery/thumb-sm-4.jpg" alt=""></li>
									</ul>
								</div>
					...
					<div class="col-md-4 col-sm-12">
						<div class="blox_instagram_preview mb-4">
							...
							<div class="padd-10 blox_instagram_preview_container">
								<div class="blox_image_box">
									<ul class="blox_image_list">
										<li><img src="assets/dist/img/gallery/thumb-sm-6.jpg" alt=""></li>
										<li><img src="assets/dist/img/gallery/thumb-sm-3.jpg" alt=""></li>
										<li><img src="assets/dist/img/gallery/thumb-sm-12.jpg" alt=""></li>
										<li><img src="assets/dist/img/gallery/thumb-sm-9.jpg" alt=""></li>
									</ul>
								</div>
					...
					<div class="col-md-4 col-sm-12">
						<div class="blox_instagram_preview mb-4">
							...
							<div class="padd-10 blox_instagram_preview_container">
								<div class="blox_image_box">
									<ul class="blox_image_list">
										<li><img src="assets/dist/img/gallery/thumb-sm-5.jpg" alt=""></li>
										<li><img src="assets/dist/img/gallery/thumb-sm-6.jpg" alt=""></li>
										<li><img src="assets/dist/img/gallery/thumb-sm-7.jpg" alt=""></li>
										<li><img src="assets/dist/img/gallery/thumb-sm-8.jpg" alt=""></li>
									</ul>
								</div>
								
								<div class="blox_instagram_info">
									<div class="blox_profile_pic">
										<img src="assets/dist/img/user-3.jpg" alt="">
									</div>
